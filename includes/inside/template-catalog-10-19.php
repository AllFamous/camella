                                ...
                                ?>
                                    ...
                                    <div class="gallery-container">
                                        ...
                                        <?php
                                            ...
                                            echo '<li><a href="#" data-toggle="tooltip" data-placement="top" title="view image" data-toggle="lightbox" data-gallery="floorPlanImages" data-remote="'.$floorPlanImage.'" data-title="Image" class="gallery-lightbox"><img src="'.$floorPlanImage.'" width="200px"></a><li>';
                                        ?>
                                        </ul>
                                    </div>
                                <?php
